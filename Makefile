...
.PHONY: cmds
cmds: build/bin/ndndpdk-ctrl build/bin/ndndpdk-godemo build/bin/ndndpdk-hrlog2histogram build/bin/ndndpdk-packetdemo build/bin/ndnfw-dpdk build/bin/ndnping-dpdk
