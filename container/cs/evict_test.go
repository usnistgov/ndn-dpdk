...
func TestDirectLru(t *testing.T) {
	...
	defer fixture.Close()
	assert.Equal(400, fixture.Cs.Capacity(cs.ListMd))
	...
	assert.True(fixture.Cs.CountEntries(cs.ListMd) <= 400)
	...
	assert.Greater(fixture.Cs.CountEntries(cs.ListMdT2), 100)
...
func TestDirectArc(t *testing.T) {
	...
	assert.Equal(100, fixture.Cs.CountEntries(cs.ListMdT1))
	assert.Equal(0, fixture.Cs.CountEntries(cs.ListMdB1))
	assert.Equal(0, fixture.Cs.CountEntries(cs.ListMdT2))
	assert.Equal(0, fixture.Cs.CountEntries(cs.ListMdB2))

	// use 1-60 (T1), p=0, T1=[61..100], T2=[1..60]
	fixture.FindBulk(1, 60, "/N/%d", "/N/%d")
	assert.InDelta(0.0, fixture.Cs.ReadDirectArcP(), 0.1)
	assert.Equal(40, fixture.Cs.CountEntries(cs.ListMdT1))
	assert.Equal(0, fixture.Cs.CountEntries(cs.ListMdB1))
	assert.Equal(60, fixture.Cs.CountEntries(cs.ListMdT2))
	assert.Equal(0, fixture.Cs.CountEntries(cs.ListMdB2))
	...
	assert.InDelta(0.0, fixture.Cs.ReadDirectArcP(), 0.1)
	assert.Equal(40, fixture.Cs.CountEntries(cs.ListMdT1))
	assert.Equal(30, fixture.Cs.CountEntries(cs.ListMdB1))
	assert.Equal(60, fixture.Cs.CountEntries(cs.ListMdT2))
	assert.Equal(0, fixture.Cs.CountEntries(cs.ListMdB2))
	...
	assert.Equal(20, fixture.Cs.CountEntries(cs.ListMdT1))
	assert.Equal(30, fixture.Cs.CountEntries(cs.ListMdB1))
	assert.Equal(80, fixture.Cs.CountEntries(cs.ListMdT2))
	assert.Equal(0, fixture.Cs.CountEntries(cs.ListMdB2))

	// insert 111-120 (T1), p=20, T1=[121..130], B1=[81..110], T2=[1..80,111..120]
	fixture.InsertBulk(111, 120, "/N/%d", "/N/%d")
	assert.InDelta(20.0, fixture.Cs.ReadDirectArcP(), 0.1)
	assert.Equal(10, fixture.Cs.CountEntries(cs.ListMdT1))
	assert.Equal(30, fixture.Cs.CountEntries(cs.ListMdB1))
	assert.Equal(90, fixture.Cs.CountEntries(cs.ListMdT2))
	assert.Equal(0, fixture.Cs.CountEntries(cs.ListMdB2))
	...
	assert.Equal(30, fixture.Cs.CountEntries(cs.ListMdB1))
	assert.Equal(80, fixture.Cs.CountEntries(cs.ListMdT2))
	assert.Equal(10, fixture.Cs.CountEntries(cs.ListMdB2))
	...
	assert.Equal(19, fixture.Cs.CountEntries(cs.ListMdT1))
	assert.Equal(31, fixture.Cs.CountEntries(cs.ListMdB1))
	assert.Equal(81, fixture.Cs.CountEntries(cs.ListMdT2))
	assert.Equal(9, fixture.Cs.CountEntries(cs.ListMdB2))
}
...
func TestIndirectLru(t *testing.T) {
	...
	fixture := NewFixture(cfg)
	defer fixture.Close()
	assert.Equal(400, fixture.Cs.Capacity(cs.ListMi))
	...
	assert.True(fixture.Cs.CountEntries(cs.ListMi) <= 400)
