...
func TestDirectArc(t *testing.T) {
	...
	assert.Equal(100, fixture.Cs.CountEntries(cs.CSL_MD_T1))
	assert.Equal(0, fixture.Cs.CountEntries(cs.CSL_MD_B1))
	assert.Equal(0, fixture.Cs.CountEntries(cs.CSL_MD_T2))
	assert.Equal(0, fixture.Cs.CountEntries(cs.CSL_MD_B2))

	// use 1-60 (T1), p=0, T1=[61..100], T2=[1..60]
	fixture.FindBulk(1, 60, "/N/%d", "/N/%d")
	assert.InDelta(0.0, fixture.Cs.ReadDirectArcP(), 0.1)
	assert.Equal(40, fixture.Cs.CountEntries(cs.CSL_MD_T1))
	assert.Equal(0, fixture.Cs.CountEntries(cs.CSL_MD_B1))
	assert.Equal(60, fixture.Cs.CountEntries(cs.CSL_MD_T2))
	assert.Equal(0, fixture.Cs.CountEntries(cs.CSL_MD_B2))
	...
	assert.InDelta(0.0, fixture.Cs.ReadDirectArcP(), 0.1)
	assert.Equal(40, fixture.Cs.CountEntries(cs.CSL_MD_T1))
	assert.Equal(30, fixture.Cs.CountEntries(cs.CSL_MD_B1))
	assert.Equal(60, fixture.Cs.CountEntries(cs.CSL_MD_T2))
	assert.Equal(0, fixture.Cs.CountEntries(cs.CSL_MD_B2))
	...
	assert.Equal(20, fixture.Cs.CountEntries(cs.CSL_MD_T1))
	assert.Equal(30, fixture.Cs.CountEntries(cs.CSL_MD_B1))
	assert.Equal(80, fixture.Cs.CountEntries(cs.CSL_MD_T2))
	assert.Equal(0, fixture.Cs.CountEntries(cs.CSL_MD_B2))

	// insert 111-120 (T1), p=20, T1=[121..130], B1=[81..110], T2=[1..80,111..120]
	fixture.InsertBulk(111, 120, "/N/%d", "/N/%d")
	assert.InDelta(20.0, fixture.Cs.ReadDirectArcP(), 0.1)
	assert.Equal(10, fixture.Cs.CountEntries(cs.CSL_MD_T1))
	assert.Equal(30, fixture.Cs.CountEntries(cs.CSL_MD_B1))
	assert.Equal(90, fixture.Cs.CountEntries(cs.CSL_MD_T2))
	assert.Equal(0, fixture.Cs.CountEntries(cs.CSL_MD_B2))
	...
	assert.Equal(30, fixture.Cs.CountEntries(cs.CSL_MD_B1))
	assert.Equal(80, fixture.Cs.CountEntries(cs.CSL_MD_T2))
	assert.Equal(10, fixture.Cs.CountEntries(cs.CSL_MD_B2))
	...
	assert.Equal(19, fixture.Cs.CountEntries(cs.CSL_MD_T1))
	assert.Equal(31, fixture.Cs.CountEntries(cs.CSL_MD_B1))
	assert.Equal(81, fixture.Cs.CountEntries(cs.CSL_MD_T2))
	assert.Equal(9, fixture.Cs.CountEntries(cs.CSL_MD_B2))
}
