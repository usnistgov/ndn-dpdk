...
func TestInsertErase(t *testing.T) {
	...
	assert.Zero(fixture.Cs.CountEntries(cs.ListDirect))
...
func TestPrefixMatch(t *testing.T) {
	...
	assert.True(ok)
	assert.Equal(1, fixture.Cs.CountEntries(cs.ListDirect))
	assert.Equal(2, fixture.Cs.CountEntries(cs.ListIndirect))
	...
	assert.Equal(0, fixture.Cs.CountEntries(cs.ListDirect))
