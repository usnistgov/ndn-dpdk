...
func TestEtherAddr(t *testing.T) {
	...
	a, e := dpdk.ParseEtherAddr("XXXX")
	assert.Error(e)

	a, e = dpdk.ParseEtherAddr("02:00:00:00:AB:01:00:00")
	assert.Error(e)

	a, e = dpdk.ParseEtherAddr("00-00-00-00-00-00")
	require.NoError(e)
	...
	a, e = dpdk.ParseEtherAddr("02:00:00:00:AB:01")
	require.NoError(e)
	...
	b, e := dpdk.ParseEtherAddr("03:00:00:00:AB:01")
	require.NoError(e)
	assert.False(a.IsZero())
...
func TestEtherAddrJson(t *testing.T) {
	...
	a, _ := dpdk.ParseEtherAddr("03:00:00:00:AB:01")
