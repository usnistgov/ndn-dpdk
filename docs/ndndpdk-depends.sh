...
DFLT_NODEVER=16.x
DFLT_GOVER=latest
DFLT_UBPFVER=2146a126e6feb76c2ef34450a059191e66c745a4
DFLT_LIBBPFVER=v1.1.0
DFLT_XDPTOOLSVER=v1.2.10
DFLT_URINGVER=liburing-2.3
DFLT_DPDKVER=v23.03-rc4
DFLT_DPDKPATCH=
DFLT_DPDKOPTS={}
DFLT_SPDKVER=ecc80dfcfbc68b5423cc724dd9d76700586f97e7
DFLT_NJOBS=$(nproc)
